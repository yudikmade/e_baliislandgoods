...
@section('content')
<div class="container margin-shop-page" id="container-cart">
                    ...
                    <div class="summary">
                        ...
                        <table class="table cart-total-table">
                            <tbody>
                                    ...
                                    @php
                                        $taxTotal = ($tax->meta_value * $countSubTotal) / 100;
                                    ...
                                    <tr>
                                        <td>@lang('cart.tax')</td>
                                        <td class="btm-plc-tax total-cart" data-tax="{{$tax->meta_value}}" data-tax-total="{{$taxTotal}}"><b><span>{{$showTax}}</span></b></td>
                                    </tr>
                                    <tr>
                        ...
                        <button class="btn btn-primary btn-check-out"><b>@lang('cart.checkout')</b></button>
                        @else
                        <button class="btn btn-primary btn-check-out"><b>@lang('cart.continue_payment')</b></button>
                        @endif
                        <br><br>
