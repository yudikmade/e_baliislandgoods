        ...
        <?php
            ...
            if(sizeof($shipping_data) > 0){
                foreach ($shipping_data as $key => $value) {
                    ...
                    $shippingPacket = $value->shipping_packet;
                    $shippingDescription = $value->shipping_description;
                }
            }
            ...
            if(Session::get(sha1(env('AUTHOR_SITE').'_checkout_shipping')) != ''){
                ...
                $city_id = $tmpData['city_id'];
                $city_name = $tmpData['city_name'];
                $subdistrict_id = $tmpData['subdistrict_id'];
                $subdistrict_name = $tmpData['subdistrict_name'];
                $address = $tmpData['address'];
                $postalcode = $tmpData['postal_code'];
            ...
            foreach ($shipping_data as $key) {
                ...
                if($key->shipping_description != ''){
                    $shipping_description = ':'.$key->shipping_description;
                }
                $valueChooseShipping = $key->shipping_packet.$shipping_description.'_'.$header_transaction->shipping_cost.'_'.$key->rupiah_cost.'_'.$key->shipping_estimate;
            }
                            ...
                            <div class="col-12 plc-shipping-form">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 no-pdg-lt">
                                        ...
                                        <div class="form-group select-national select-subdistrict none {{$national}}">
