            ...
            <tbody>
                ...
                <?php
                    ...
                    foreach ($data_result as $key) 
                    {
                        echo '
                            <tr>
                                <td width="20px"><input value="'.$key->faq_id.'" type="checkbox" class="minimal" name="data'.$no.'" id="data'.$no.'"></td>
                                <td>'.$no.'</td>
                                <td>'.$key->question.'?</td>
                                <td>
                                    <a class="btn btn-success btn-sm" title="Edit data" href="'.route('control_edit_faq').'/'.$key->faq_id.'"><i class="fa fa-edit"></i></a>
                                    <a class="btn btn-danger btn-sm" title="Delete data" href="'.route('control_action_faq').'/'.$key->faq_id.'" data-confirm="Are you sure delete this data ?"><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
                        ';
                        $no++;
                    ...
                    <th colspan="7">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                {{ csrf_field() }}
                                <li><a href="javascript:void(0);" class="actionAll" data-url="{{route('control_action_faq')}}" data-status="delete">Delete</a></li>
                            </ul>
